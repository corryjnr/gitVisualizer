...
// openFile opens the file located at 'filePath'. Creates if if not existing.
...
// of each line and parses it to to a slice of strings
...
// joinSlices add the element if the 'new' slice
...
// dumpStringsSliceToFile writes content to the file in path 'filePath'
...
// recursiveScanFolder starts the recursive search of got repositories
...
// Recursively searches in the subfolders by passing an existing 'folder' slice.
